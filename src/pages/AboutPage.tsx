...
import { AngularLinesDecor, RectangleCircleDecor } from "@/components/decorative/GeometricShapes";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-24 md:py-32 bg-gradient-to-b from-background to-graphite relative overflow-hidden">
        <AngularLinesDecor className="absolute top-16 right-10 opacity-20 animate-pulse" />
        <RectangleCircleDecor className="absolute bottom-20 left-10 opacity-20" />
