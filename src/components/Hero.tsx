...
import frogIconTransparent from "@/assets/frog-icon-dark-transparent.png";
      ...
      <div className="container mx-auto px-4 md:px-6 py-24 md:py-32 relative z-10">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex justify-center mb-8">
            <img src={frogIconTransparent} alt="RevUp Mascot" className="h-20 md:h-24 w-auto drop-shadow-lg" />
          </div>
          ...
          <div className={`flex justify-center transition-all duration-700 ${showButton ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
            <Button 
              ...
              className="text-lg md:text-xl px-10 md:px-14 py-7 md:py-9 h-auto hover:scale-105 transition-all duration-500 shadow-xl"
